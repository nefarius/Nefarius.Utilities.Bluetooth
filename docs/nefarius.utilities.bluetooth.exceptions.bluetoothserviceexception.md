...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → [BluetoothServiceException](./nefarius.utilities.bluetooth.exceptions.bluetoothserviceexception.md)<br>
