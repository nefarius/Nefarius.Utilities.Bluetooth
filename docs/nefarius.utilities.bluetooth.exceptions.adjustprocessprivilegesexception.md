...
Inheritance [Object](https://learn.microsoft.com/dotnet/api/system.object) → [Exception](https://learn.microsoft.com/dotnet/api/system.exception) → [AdjustProcessPrivilegesException](./nefarius.utilities.bluetooth.exceptions.adjustprocessprivilegesexception.md)<br>
